...
#define MX_ENABLE_PORT P1
#define MX_ENABLE_PIN BIT7
#define MX_ENABLE_PORT_SEL0 P1SEL0
#define MX_ENABLE_PORT_SEL1 P1SEL1
#define MX_ENABLE_PORT_DIR P1DIR
#define MX_ENABLE_PORT_OUT P1OUT

#define MY_ENABLE_PORT P5
#define MY_ENABLE_PIN BIT0
#define MY_ENABLE_PORT_SEL0 P5SEL0
#define MY_ENABLE_PORT_SEL1 P5SEL1
#define MY_ENABLE_PORT_DIR P5DIR
#define MY_ENABLE_PORT_OUT P5OUT
...
#define MX_DIR_PORT 1
#define MX_DIR_PIN BIT0
#define MX_DIR_PORT_SEL0 P1SEL0
#define MX_DIR_PORT_SEL1 P1SEL1
#define MX_DIR_PORT_DIR P1DIR
#define MX_DIR_PORT_OUT P1OUT


#define MY_DIR_PORT P5
#define MY_DIR_PIN BIT1
#define MY_DIR_PORT_SEL1 P5SEL1
#define MY_DIR_PORT_SEL0 P5SEL0
#define MY_DIR_PORT_DIR P5DIR
#define MY_DIR_PORT_OUT P5OUT
...
#define MX_STEP_PORT P1
#define MX_STEP_PIN BIT1
#define MX_STEP_PORT_SEL0 P1SEL0
#define MX_STEP_PORT_SEL1 P1SEL1
#define MX_STEP_PORT_DIR P1DIR
#define MX_STEP_PORT_OUT P1OUT


#define MY_STEP_PORT P5
#define MY_STEP_PIN BIT2
...
#define PUMP_ENABLE_PORT P1
#define PUMP_ENABLE_PIN BIT3
#define PUMP_ENABLE_SEL0 P1SEL0
#define PUMP_ENABLE_SEL1 P1SEL1
#define PUMP_ENABLE_DIR P1DIR
#define PUMP_ENABLE_OUT P1OUT

#define PUMP_DISABLE PUMP_ENABLE_OUT&=~PUMP_ENABLE_PIN
#define PUMP_ENABLE PUMP_ENABLE_OUT|=PUMP_ENABLE_PIN

#define PUMP_REVERSE_PORT P4
#define PUMP_REVERSE_PIN BIT5
#define PUMP_REVERSE_SEL0 P4SEL0
#define PUMP_REVERSE_SEL1 P4SEL1
#define PUMP_REVERSE_DIR P4DIR
#define PUMP_REVERSE_OUT P4OUT

#define PUMP_DIRECTION_PORT P3
#define PUMP_DIRECTION_PIN BIT5
#define PUMP_DIRECTION_SEL0 P3SEL0
#define PUMP_DIRECTION_SEL1 P3SEL1
#define PUMP_DIRECTION_DIR P3DIR
#define PUMP_DIRECTION_OUT P3OUT

#define PUMP_EXTRUDE PUMP_DIRECTION_OUT|=PUMP_DIRECTION_PIN
#define PUMP_REVERSE PUMP_DIRECTION_OUT&=PUMP_DIRECTION_PIN
...
#define MY_LIMIT_PORT_SEL0 P2SEL0
#define MY_LIMIT_PORT_SEL1 P2SEL1
#define MY_LIMIT_PORT_DIR P2DIR
#define MY_LIMIT_PORT_OUT P2OUT
#define MY_LIMIT_PORT_IFG P2IFG
#define MY_LIMIT_PORT_IE P2IE
#define MY_LIMIT_PORT_IES P2IES
#define MY_LIMIT_PORT_IN P2IN
#define MY_LIMIT_PORT_REN P2REN
#define MY_LIM0 (MY_LIMIT_PORT_IN & MY_LIMIT_0_PIN)
#define MY_LIM1 (MY_LIMIT_PORT_IN & MY_LIMIT_1_PIN)
