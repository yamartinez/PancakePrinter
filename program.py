#!/usr/bin/python3
#changes: commented out import serial and the last three lines of code, debug = False, not more prints
#Output
...
if (__name__ == "__main__"):
    ...
    name = sys.argv[1]
    img = cv2.imread(name)
    edges = processImage(img, debug)
    find_coordinates(edges, sys.argv[2], debug)
    x = UART()
